...
@section('title', 'Registrate como Fotógrafo')
        ...
        <div class="col-12 text-center">
            ...
            <div id="background-register" class="row pt-4">
                ...
                <div class="col-12">
                    ...
                    <form id="formCreateAccount" class="mb-4" method="POST" action="{{ route('register') }}" onsubmit="preventMultipleSubmitForm(this, '{{ asset('icons/blocks.svg')}}')">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="birthdate" id="fecha_nacimiento" class="form-control mx-auto" style="max-width: 24rem; font-size: 1.2rem;" value="{{ old('birthdate') }}">
                        </div>
