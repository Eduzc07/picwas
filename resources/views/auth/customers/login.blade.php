...
@section('title', 'Quiero buscar mis fotos')
...
<div class="container text-white h-100">
    <div class="row align-items-center" style="height: 80vh;">
        <div class="col-12 text-center">
            ...
            <div class="row">
                <div class="col-12">
                    <form id="formLogin" class="form-inline justify-content-center mb-4" method="POST" action="{{ route('customers.login') }}" onsubmit="preventMultipleSubmitForm(this, '{{ asset('icons/blocks.svg')}}')">
                        @csrf
