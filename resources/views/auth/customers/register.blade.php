    ...
    <div class="row align-items-center" style="height: 100vh;">
        <div class="col-12 text-center bg-white">
            ...
            <div id="background-register" class="row pt-4">
                ...
                <div class="col-12">
                    <h3 class="color-1"><u>Crea una cuenta gratis</u></h3>

                    <form id="formCreateAccount" class="mb-4" method="POST" action="{{ route('customers.register') }}" onsubmit="preventMultipleSubmitForm(this, '{{ asset('icons/blocks.svg')}}')">
                        @csrf
                        <input type="text" class="form-control p-3 mb-2 mx-auto" name="firstname" placeholder="Nombre" style="max-width: 24rem; font-size: 1.2rem;" value="{{ old('firstname') }}">

                        <input type="text" class="form-control p-3 mb-2 mx-auto" name="lastname" placeholder="Apellidos" style="max-width: 24rem; font-size: 1.2rem;" value="{{ old('lastname') }}">

                        <input type="text" class="form-control p-3 mb-2 mx-auto" name="username" placeholder="Nombre de usuario" style="max-width: 24rem; font-size: 1.2rem;" value="{{ old('username') }}">

                        <div class="form-group">
                            <label for="fecha_nacimiento" class="mb-0 mt-2"><h5>Fecha de nacimiento</h5></label>
                            <input type="date" max="2002-12-31" pattern="[0-9]{4}" name="birthdate" id="fecha_nacimiento" class="form-control mx-auto" style="max-width: 24rem; font-size: 1.2rem;" value="{{ old('birthdate') }}">
                        </div>
