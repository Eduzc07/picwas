...
<div class="container text-white h-100">
    <div class="row align-items-center" style="height: 100vh;">
        <div class="col-12 text-center">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="form-inline justify-content-center mb-4"method="POST" action="{{ route('login') }}">
                        @csrf
    ...
    <div class="mx-auto fixed-bottom bg-red-opacity-50 w-100 h-100 rounded-circle d-none d-md-block" style="z-index: -888; max-width: 180px; max-height: 180px; bottom: -30px;">
        <div class="h-100">
            <img class="img-fluid p-4 align-self-center mt-3" src="{{ asset('img/tmp-home-logo-image.png') }}" alt="">
        </div>
    </div>
</div>
@endsection
