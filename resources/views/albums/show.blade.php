...
<div class="container-fluid pt-2" style="background: #fafafa;">
    <div class="row">
                  ...
                  <form id="formAddPhotos" method="POST" action="{{ route('photos.store', [$album->id]) }}" enctype="multipart/form-data" onsubmit="preventMultipleSubmitForm(this, '{{ asset('icons/blocks.svg')}}', 'left')">
                      ...
                      <div class="row" style="height: 60px;">
                         <div class="col-sm-3 my-auto">
                           <label for="add_photos" class="form-label">Agregar fotos al album:</label>
                         </div>
                          ...
                          @can('album_owner', $album)
                              ...
                              <div class="text-center  pt-2">
                                  ...
                                  <div class="input-group inline-group">
                                    ...
                                    <input id="input-price" class="form-control quantity font-weight-bold color-1" name="quantity" value="{{config('app.price_per_photo')}}" lang="en" data-decimals="2" min="0" max="100" step="1.00" type="number" placeholder='0.00' onchange="setTwoNumberDecimal(this);">
                  ...
                  <div class="modal-dialog modal-xl modal-dialog-centered">
                      <div class="modal-content" width="800" style="background: #000000d0;">
                          <div class="d-flex flex-row justify-content-center">
                              ...
                              <img id="image-gallery-image" class="img-responsive p-0" height="500" src="" style="max-height: 550px; margin: 0px; padding: 0px; background: red;">
                          </div>
                          <!-- modal-footer  -->
    ...
    <script>
        ...
        $('.btn-plus, .btn-minus').on('click', function(e) {
          ...
          if (input.is('input')) {
            ...
            input[0].value = parseFloat(newValue).toFixed(2);
          }
        })
