...
<nav class="navbar navbar-expand-sm navbar-dark bg-transparent text-white bg-img-navbar" style="background-image: url(@yield("navbarImg", asset('img/photographer_header.jpg')));">
    ...
    <a class="navbar-brand pt-0 d-md-none" href="{{route('user', [Auth::user()->username])}}"><img src="@yield("navbarBrandImg", asset('img/logo_white_shadow.png'))" alt="" class="img-fluid" style="max-height: 52px"></a>
        ...
        <ul class="navbar-nav mt-2 mt-lg-0 ml-auto">
            ...
            <li class="nav-item">
                <a href="{{route('cart')}}" class="btn p-0 m-0 w-100 text-left" title="Carrito de compra" alt="Carrito de compra">
                    ...
                    <span class="badge badge-info" style="font-size:9px; position:relative; top: -18px; left: -10px;">{{ $items }}</span>
...
<div class="bg-red-opacity-50 w-100 h-100 rounded-circle d-none d-md-block" style="top: -32px; left: 32px; max-width: 168px; max-height: 168px; position: absolute;">
    <div class="row h-100 p-3">
        ...
        <a class="p-3 align-self-center" href="{{route('user', [Auth::user()->username])}}"><img class="img-fluid align-self-center" src="{{ asset('img/logo_white_shadow.png') }}" alt=""></a>
    </div>
</div>
