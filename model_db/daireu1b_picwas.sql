...
--
-- Host: localhost:3306
-- Generation Time: Jul 10, 2020 at 10:45 PM
...
--
-- Database: `daireu1b_picwas`
--
CREATE DATABASE IF NOT EXISTS `daireu1b_picwas` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `daireu1b_picwas`;
...
--
-- Table structure for table `purchased_photos`
--
...
--
-- Indexes for table `purchased_photos`
--
...
--
-- AUTO_INCREMENT for table `purchased_photos`
--
ALTER TABLE `purchased_photos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `purchased_photos`
--
ALTER TABLE `purchased_photos`
